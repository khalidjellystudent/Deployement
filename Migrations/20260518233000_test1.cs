        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvidenceImageData = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    EvidenceImageContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VoiceReportPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
